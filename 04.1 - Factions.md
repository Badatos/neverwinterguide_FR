...
![Assassin Rat-Garou](10%20-%20Appendix%20C%20-%20Creatures/WereratAssassin.jpg =280x){.print-bottom-right .with-margin}
...
![Emblème des Nashers, dessiné par DALL-E avec ’un symbole représentant la tête d’un minotaure transpercée d’une épée, imprimé en rouge sur de la toile de jute’](Images/Factions/Nashers.jpg =240x)<!--{p.text-center}-->
...
*Nasher Alagondar*, précédent seigneur de Padhiver ![Nasher Alagondar, précédent seigneur de Padhiver](https://static.wikia.nocookie.net/forgottenrealms/images/a/a5/Nasher.png =220x)<!--{p:.print-bottom-right .with-margin}-->
...
À ce jour les villes membres de l’Alliance des seigneurs sont Eauprofonde, Padhiver, Lunargent, la Porte de Baldur, Le Gué de la dague, Mirabar, Longueselle, Castelmithral, Amphail et Yartar.
